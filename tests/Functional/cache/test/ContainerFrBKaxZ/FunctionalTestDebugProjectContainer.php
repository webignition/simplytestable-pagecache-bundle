...
class FunctionalTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array(), $containerDir = __DIR__)
    {
        ...
        $this->fileMap = array(
            'SimplyTestable\\PageCacheBundle\\Tests\\Functional\\EntityManagerProxy' => 'getEntityManagerProxyService.php',
            ...
            'simplytestable_pagecache.cache_validator_headers_service' => 'getSimplytestablePagecache_CacheValidatorHeadersServiceService.php',
            'simplytestable_pagecache.cache_validator_identifier.parameters_factory' => 'getSimplytestablePagecache_CacheValidatorIdentifier_ParametersFactoryService.php',
            'simplytestable_pagecache.cacheable_response_factory' => 'getSimplytestablePagecache_CacheableResponseFactoryService.php',
            'simplytestable_pagecache.command.cache_validator.clear' => 'getSimplytestablePagecache_Command_CacheValidator_ClearService.php',
        );
        $this->aliases = array(
            'SimplyTestable\\PageCacheBundle\\Command\\ClearCommand' => 'simplytestable_pagecache.command.cache_validator.clear',
            'SimplyTestable\\PageCacheBundle\\Services\\CacheValidatorHeadersService' => 'simplytestable_pagecache.cache_validator_headers_service',
            'SimplyTestable\\PageCacheBundle\\Services\\CacheValidatorIdentifier\\ParametersFactory' => 'simplytestable_pagecache.cache_validator_identifier.parameters_factory',
            'SimplyTestable\\PageCacheBundle\\Services\\CacheableResponseFactory' => 'simplytestable_pagecache.cacheable_response_factory',
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'SimplyTestablePageCacheBundle' => array(
                    'path' => ($this->targetDirs[4].'/src'),
                    'namespace' => 'SimplyTestable\\PageCacheBundle',
                ),
            ); break;
            case 'debug.container.dump': $value = ($this->targetDirs[0].'/FunctionalTestDebugProjectContainer.xml'); break;
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'SimplyTestablePageCacheBundle' => 'SimplyTestable\\PageCacheBundle\\SimplyTestablePageCacheBundle',
            ),
            ...
            'console.command.ids' => array(
                ...
                4 => 'simplytestable_pagecache.command.cache_validator.clear',
            ),
        );
    }
}
